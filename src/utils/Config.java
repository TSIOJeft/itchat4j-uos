...
import com.farplace.farpush.itchat.utils.enums.OsNameEnum;
...
public class Config {
    ...
    public static final String DELIVER_URL = "http://106.13.25.92:9090";
    public static final String MIUI_APPID = "2882303761520092058";
    public static final String OPPO_APPKEY = "38591f42a8fc4713ad9e8879be70aa35";
    public static final String OPPO_APPSECRET = "e963f0b036ec494ca47db43b9ad13793";
    public static final String MIUI_APPKEY = "5862009264058";
    public static int SYNC_HZ = 30;
    public static int SYNC_MSG = 5;
    ...
    public static String FARPUSH_URL = "http://106.13.25.92:9090";
    /**
     * 获取文件目录
     *
     * @return
